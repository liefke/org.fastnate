...
public class GeneratorTable {
	...
	public GeneratorColumn resolveColumn(final String columnName) {
		final boolean autoGenerated = false;
		return resolveColumn(columnName, autoGenerated);
	}
	...
	public GeneratorColumn resolveColumn(final String columnName, final boolean autoGenerated) {
		final GeneratorColumn column = new GeneratorColumn(this.columns.size(), columnName, autoGenerated);
		final GeneratorColumn oldColumn = this.columns.put(columnName, column);
		if (oldColumn != null) {
			this.columns.put(columnName, oldColumn);
			return oldColumn;
		}
