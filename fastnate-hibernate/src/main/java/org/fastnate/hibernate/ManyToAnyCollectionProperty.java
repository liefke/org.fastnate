...
/**
 * Describes a property of an {@link EntityClass} that references a collection of entities according to a
 * {@link ManyToAny} mapping.
 *
 * @param <E>
 ...
 */
public class ManyToAnyCollectionProperty<E, T> extends CollectionProperty<E, T> {
	 ...
	 */
	public ManyToAnyCollectionProperty(final EntityClass<?> sourceClass, final AttributeAccessor attribute,
